...
% boundary conditions. (note, this will take ~2 hours to run)
% 
...
% lines 165-166 to load Eocene boundary conditions. (note, this will take 
% ~2 hours to run)
% 
% ------------------------------------------------------------------------
clear vars
...
ageEnd = 1e6;  % how many model years to run?

% edit figure properties
figN = 1; % figure number
linlog = 0; % edit here, log = 0
